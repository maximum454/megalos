    ...
    <div class="bx_filter_section">
        <form name="<? echo $arResult["FILTER_NAME"] . "_form" ?>" action="<? echo $arResult["FORM_ACTION"] ?>"
                    ...
                    <div class="bx_filter_block">
                        <div class="bx_filter_parameters_box_container">
                            ...
                            ?>
                                <div class="filter__group">
                                    <div>
                                        <label class="filter__label" for="human">От</label>
                                        <input
                                                class="min-price filter__input"
                                                type="text"
                                                name="<?
                                    ...
                                    <div class="filter__equally">=</div>

                                    <div>
                                        <label class="filter__label" for="human">До</label>
                                        <input
                                                class="max-price filter__input"
                                                type="text"
                                                name="<?
            ...
            <div class="bx_filter_button_box active">
                <div class="bx_filter_block">
                    <div class="bx_filter_parameters_box_container">
                        <input class="filter__btn calc" type="submit" id="set_filter" name="set_filter"
